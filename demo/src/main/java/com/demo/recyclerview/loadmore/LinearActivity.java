...
import com.demo.recyclerview.loadmore.adapter.LinearAdapter;
...
public class LinearActivity extends AppCompatActivity {
    ...
    private void initListeners() {
        ALinearLayoutManager layoutManager = new ALinearLayoutManager(this);
        recyclerview.setLayoutManager(layoutManager);
        ALinearSpaceDecoration itemDecoration = new ALinearSpaceDecoration(layoutManager.getOrientation(), ScreenUtil.dp2px(10));
