...
/**
 * 空白分割线 for {@link androidx.recyclerview.widget.StaggeredGridLayoutManager}
 *
 * @date 2021/1/24
 */
public class AStaggeredGridSpaceDecoration extends ABaseSpaceDecoration {

    private static final String TAG = AStaggeredGridSpaceDecoration.class.getSimpleName();
     ...
     * @param space       item间距
     */
    public AStaggeredGridSpaceDecoration(@RecyclerView.Orientation int orientation, int space) {
     ...
     */
    public AStaggeredGridSpaceDecoration(@RecyclerView.Orientation int orientation, int horizontalSpace, int verticalSpace) {
     ...
     * @param space       item间距
     */
    public AStaggeredGridSpaceDecoration(@RecyclerView.Orientation int orientation, boolean includeEdge, int space) {
     ...
     * @param verticalSpace   纵间距
     */
    public AStaggeredGridSpaceDecoration(@RecyclerView.Orientation int orientation, boolean includeEdge, int horizontalSpace, int verticalSpace) {
